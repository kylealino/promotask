        ...
        <div class="card-body">
          ...
          <div class="row mb-3">
            <div class="col-lg-12">
              ...
              <div class="row mb-3">
                <label class="col-sm-3 form-label" for="txt_buyxtakeytrxno">Buy One Take One Code:</label>
                <div class="col-sm-9">
                  <input type="text" id="txt_buyxtakeytrxno" name="txt_buyxtakeytrxno" placeholder="Buy One Take One Code" style="background-color: #EAEAEA;" class="form-control form-control-sm" value="<?=$txt_buyxtakeytrxno;?>" readonly/>
      ...
      $("#mbtn_mn_Save").click(function(e){
        ...
        try { 
          ...
          for(aa = 1; aa < rowCount1; aa++) { 
            ...
            $.ajax({ 
              type: "POST",
              url: '<?=site_url();?>me-buyxtakey-save',
