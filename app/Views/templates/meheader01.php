...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="<?=site_url();?>" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">Promo Discount</span>
      </a>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2">IamUser</span>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?=site_url();?>me-dashboard">
          <i class="bi bi-grid"></i>
      ...
      <li class="nav-item">
        ...
        <ul id="memasterdata-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="<?=site_url();?>me-buyxtakey">
              <i class="bi bi-circle"></i><span>Buy 1 Take 1</span>
            </a>
          </li>
          <li>
            <a href="<?=site_url();?>me-deposit">
